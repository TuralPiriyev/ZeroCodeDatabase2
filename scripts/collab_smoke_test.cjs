// collab_smoke_test.cjs
// CommonJS smoke test that opens two socket clients, listens for db_update, triggers a schema save via API

const io = require('socket.io-client');
const axios = require('axios');

const SERVER = process.env.TEST_SERVER || process.env.TEST_SERVER_URL || 'http://localhost:5000';
